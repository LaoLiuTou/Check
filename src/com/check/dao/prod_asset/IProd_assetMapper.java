package com.check.dao.prod_asset;
import java.util.List;
import java.util.Map;
import com.check.model.prod_asset.Prod_asset;
	public interface IProd_assetMapper {
	/**
 	* 通过id选取
 	* @return
 	*/
 ...
 */ 
 	...
 	* @return
 */ 
	public  int addprod_asset(Prod_asset prod_asset);
	/**
 	* 删除 
 	* @return 
 */ 
 ...
 * @return 
 */ 
public  int deleteprod_assetbyprod(String prodid);
