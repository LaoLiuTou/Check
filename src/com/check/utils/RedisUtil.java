...
public class RedisUtil {
	  ...
	  private static JedisPool pool;      
	    ...
	    public static String getObject(String prev,String id) {
	    	Jedis jedis = getJedisObject();//获得jedis实例 
	        String info = jedis.get(prev+":"+id);
	    ...
	    public static void setObject(String prev,String id,String info) {
	    	Jedis jedis = getJedisObject();//获得jedis实例 
	        try {
				jedis.set(prev+":"+id, info);
			} catch (Exception e) {
	    ...
	    public static void delOject(String prev,String key){
	    	Jedis jedis = getJedisObject();//获得jedis实例 
	        boolean isExist=jedis.exists(prev+":"+key);
	        if(isExist){
