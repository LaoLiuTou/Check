package com.check.action.notices;
...
public class NoticesAction implements Action {
	...
	public String add() throws Exception {
		...
		notices.setId(Long.parseLong(id));
		if(c_dt!=null&&!c_dt.equals(""))
		notices.setC_dt(sdf.parse(c_dt));
		if(up_dt!=null&&!up_dt.equals(""))
		notices.setUp_dt(sdf.parse(up_dt));
		if(c_id!=null&&!c_id.equals(""))
		notices.setC_id(Long.parseLong(c_id));
	...
	public String delete() throws Exception {
		...
		StringBuffer msg = new StringBuffer("{\"state\":");
		try {
			iNoticesService.deletenotices(id);
			msg.append("\"success\",\"msg\":");
			msg.append("\"删除成功！\"");
			logger.info(id+"删除成功！");
		} catch (Exception e) {
	...
	public String select() throws Exception {
		...
		StringBuffer msg = new StringBuffer("{\"state\":");
		try {
			notices=iNoticesService.selectnoticesById(id);
			JsonConfig jsonConfig = new JsonConfig();
			jsonConfig.registerJsonValueProcessor(Date.class, new JsonValueProcessor() {
				public Object processArrayValue(Object value, JsonConfig jsonConfig) {
					return value;  
			...
			msg.append("\"success\",\"msg\":");
			msg.append(JSONObject.fromObject(notices, jsonConfig));
			logger.info(id+"查询成功！");
		} catch (Exception e) {
