package com.check.action.group_status;
...
import com.check.service.group_status.IGroup_statusService;
import com.check.model.group_status.Group_status;
public class Group_statusAction implements Action {
	private int page;
	private int size;
	...
	@Autowired
	private IGroup_statusService iGroup_statusService;
	private List<Group_status> list;
	...
	public List<Group_status> getList() {
		return list;
	}
	public void setList(List<Group_status> list) {
		this.list = list;
	}
	...
	public String add() throws Exception {
		...
		Group_status group_status =new Group_status(); 
		if(id!=null&&!id.equals(""))
		group_status.setId(Long.parseLong(id));
		if(group_id!=null&&!group_id.equals(""))
		group_status.setGroup_id(Long.parseLong(group_id));
		if(status_id!=null&&!status_id.equals(""))
		group_status.setStatus_id(Long.parseLong(status_id));
		if(c_dt!=null&&!c_dt.equals(""))
		group_status.setC_dt(sdf.parse(c_dt));
		if(up_dt!=null&&!up_dt.equals(""))
		group_status.setUp_dt(sdf.parse(up_dt));
		StringBuffer msg = new StringBuffer("{\"state\":");
		try {
			int result = Integer.parseInt(iGroup_statusService.addgroup_status(group_status).toString());
			msg.append("\"success\",\"msg\":\"");
			msg.append(group_status.getId()+"\"");
	...
	public String list() throws Exception {
		...
		StringBuffer msg = new StringBuffer("{\"state\":");
		try {
			list=iGroup_statusService.selectgroup_statusByParam(paramMap); 
			totalnumber=iGroup_statusService.selectCountgroup_statusByParam(paramMap);
	...
	public String update() throws Exception {
		...
		StringBuffer msg = new StringBuffer("{\"state\":");
		try {
			iGroup_statusService.updategroup_status(group_status);
			msg.append("\"success\",\"msg\":");
			msg.append("\"更新成功！\"");
			logger.info(id+"更新成功！");
		} catch (Exception e) {
	...
	public String delete() throws Exception {
		...
		StringBuffer msg = new StringBuffer("{\"state\":");
		try {
			iGroup_statusService.deletegroup_status(id);
			msg.append("\"success\",\"msg\":");
			msg.append("\"删除成功！\"");
			logger.info(id+"删除成功！");
		} catch (Exception e) {
	...
	public String select() throws Exception {
		...
		StringBuffer msg = new StringBuffer("{\"state\":");
		try {
			group_status=iGroup_statusService.selectgroup_statusById(id);
			JsonConfig jsonConfig = new JsonConfig();
			jsonConfig.registerJsonValueProcessor(Date.class, new JsonValueProcessor() {
				public Object processArrayValue(Object value, JsonConfig jsonConfig) {
					return value;  
			...
			msg.append("\"success\",\"msg\":");
			msg.append(JSONObject.fromObject(group_status, jsonConfig));
			logger.info(id+"查询成功！");
		} catch (Exception e) {
