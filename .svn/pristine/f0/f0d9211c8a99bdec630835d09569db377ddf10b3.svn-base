...
public class AttaAction implements Action {
	private int page;
	private int size;
	...
	public List<Atta> getList() {
		return list;
	}
	public void setList(List<Atta> list) {
		this.list = list;
	}
	...
	public String add() throws Exception {
		...
		atta.setId(Long.parseLong(id));
		atta.setRow_id(row_id);
		if(c_dt!=null&&!c_dt.equals(""))
		atta.setC_dt(sdf.parse(c_dt));
		if(up_dt!=null&&!up_dt.equals(""))
		atta.setUp_dt(sdf.parse(up_dt));
		atta.setC_id(c_id);
		atta.setNm_t(nm_t);
		atta.setPid(pid);
		atta.setType(type);
		...
		try {
			int result = Integer.parseInt(iAttaService.addatta(atta).toString());
			msg.append("\"success\",\"msg\":\"");
			msg.append(atta.getId()+"\"");
	...
	public String list() throws Exception {
		...
		StringBuffer msg = new StringBuffer("{\"state\":");
		try {
			list=iAttaService.selectattaByParam(paramMap); 
			totalnumber=iAttaService.selectCountattaByParam(paramMap);
	...
	public String select() throws Exception {
		...
		StringBuffer msg = new StringBuffer("{\"state\":");
		try {
			atta=iAttaService.selectattaById(id);
			JsonConfig jsonConfig = new JsonConfig();
			jsonConfig.registerJsonValueProcessor(Date.class, new JsonValueProcessor() {
				public Object processArrayValue(Object value, JsonConfig jsonConfig) {
					return value;  
			...
			msg.append("\"success\",\"msg\":");
			msg.append(JSONObject.fromObject(atta, jsonConfig));
			logger.info(id+"查询成功！");
		} catch (Exception e) {
