package com.check.dao.conclusion_templet;
import java.util.List;
import java.util.Map;
import com.check.model.conclusion_templet.Conclusion_templet;
	public interface IConclusion_templetMapper {
	/**
 	* 通过id选取
 	* @return
 	*/
 ...
 */ 
 	...
 	* @return
 */ 
	public  int addconclusion_templet(Conclusion_templet conclusion_templet);
	/**
 	* 删除 
 	* @return 
 */ 
